...
public class FrmBooking extends JFrame {
	...
	private JComboBox<String> cmbClientNames;
	private JComboBox<String> cmbChaletCodes;
	...
	private List<Chalet> chaletsList;
	...
	public FrmBooking() {
		...
		tblBooking.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Chalet Code", "Client RG",
				"Status", "Check-In Date", "Check-Out Date", "Number of Guests", "Discount", "Total Price" }) {
		...
		cmbClientNames = new JComboBox<>();
		for (Client client : clientsList) {
			cmbClientNames.addItem(client.getName());
		}

		cmbChaletCodes = new JComboBox<>();
		for (Chalet chalet : chaletsList) {
			cmbChaletCodes.addItem(String.valueOf(chalet.getChaletCode()));
		}
		...
		btnDelete.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int i = JOptionPane.showConfirmDialog(null,
						"Do you want to delete this booking for Chalet ID: "
								+ cmbChaletCodes.getSelectedItem().toString() + "?",
		...
		btnClear.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				cmbChaletCodes.setSelectedIndex(-1);
		...
		lblClientName.setFont(new Font("Arial", Font.BOLD, 14));
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(lblChaletCode).addComponent(lblClientName).addComponent(lblStatus)
										.addComponent(lblCheckInDate).addComponent(lblCheckOutDate)
										.addComponent(lblNumberGuests).addComponent(lblDiscount))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(cmbChaletCodes, GroupLayout.DEFAULT_SIZE, 1029, Short.MAX_VALUE)
										.addComponent(cmbClientNames, GroupLayout.DEFAULT_SIZE, 1029, Short.MAX_VALUE)
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblChaletCode)
								.addComponent(cmbChaletCodes, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblClientName)
								.addComponent(cmbClientNames, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblStatus)
								.addComponent(txtStatus, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblCheckInDate)
								.addComponent(txtCheckInDate, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblCheckOutDate)
								.addComponent(txtCheckOutDate, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblNumberGuests)
								.addComponent(txtNumberGuests, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblDiscount)
								.addComponent(txtDiscount, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(37).addComponent(lblMessage).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 232, Short.MAX_VALUE).addContainerGap()));
		contentPane.setLayout(gl_contentPane);
	}

	private void fillFieldsFromSelectedRow() {
		int selectedRow = tblBooking.getSelectedRow();
		String chaletCode = tblBooking.getValueAt(selectedRow, 0).toString();
		cmbChaletCodes.setSelectedItem(chaletCode);

		String clientRG = tblBooking.getValueAt(selectedRow, 1).toString();
		try {
			cmbClientNames.setSelectedItem(mapClientRGToName(clientRG));
		} catch (Exception e) {
			cmbClientNames.setSelectedIndex(0);
		}
	...
	private Booking setBookingToBeDeleted() throws Exception {
		...
		Client client;
		try {
			String chaletCode = Util.validateAndGetString(cmbChaletCodes.getSelectedItem().toString(), "Chalet Code");
			String RG = mapClientNameToRG(cmbClientNames.getSelectedItem().toString());
	...
	private Booking mapFieldsToBooking() throws Exception {
		...
		Client client;
		try {
			if (chaletsList.isEmpty())
				throw new Exception("No Chalets Registered");
			String chaletCode = Util.validateAndGetString(cmbChaletCodes.getSelectedItem().toString(), "Chalet Code");
			chalet = chc.searchByCode(chaletCode);
			if (chalet == null)
		...
		if (booking.getNumberGuests() > chalet.getCapacity()) {
			throw new Exception(String.format("Number of guests(%d) exceed chalet capacity(%d)",
					booking.getNumberGuests(), chalet.getCapacity()));
		}
	...
	private void searchBooking() {
		...
		for (Booking b : bookings) {
			ClientController cc = new ClientController();
			ChaletController chc = new ChaletController();
			tbm.addRow(new Object[] { chc.searchById(b.getChaletId()).getChaletCode(),
					cc.searchById(b.getClientId()).getRG(), b.getStatus(),
					Util.formatDateToDDMMYYYY(b.getCheckInDate()), Util.formatDateToDDMMYYYY(b.getCheckOutDate()),
					b.getNumberGuests(), b.getDiscount(), b.getTotalPrice() });
		}
	}

	private void populateClientsList() {
		ClientController cc = new ClientController();
		clientsList = cc.getAllClients();
	}

	private void populateChaletsList() {
		ChaletController cc = new ChaletController();
		chaletsList = cc.getAllChalets();
	}

	private String mapClientNameToRG(String name) throws Exception {
	...
	private String mapClientRGToName(String RG) throws Exception {
		for (Client c : clientsList) {
