...
public class FrmChalet extends JFrame {
	...
	public FrmChalet() {
		...
		tblChalet.setModel(new DefaultTableModel(new Object[][] {},
		...
		btnDelete.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int i = JOptionPane.showConfirmDialog(null,
						"Do you want to delete this chalet with Code: " + txtChaletCode.getText() + "?", "Delete",
		...
		gl_panelForm.setHorizontalGroup(gl_panelForm.createParallelGroup(Alignment.LEADING).addGroup(gl_panelForm
				...
				.addGroup(gl_panelForm.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelForm.createSequentialGroup()
								.addGroup(gl_panelForm.createParallelGroup(Alignment.LEADING)
										.addComponent(lblChaletCode).addComponent(lblLocation).addComponent(lblCapacity)
										.addComponent(lblPeakSeasonPrice).addComponent(lblNormalPrice))
								.addGap(18)
								.addGroup(gl_panelForm.createParallelGroup(Alignment.LEADING)
										.addComponent(txtChaletCode).addComponent(txtLocation).addComponent(txtCapacity)
										.addComponent(txtPeakSeasonPrice).addComponent(txtNormalPrice)))
		...
		gl_panelForm.setVerticalGroup(gl_panelForm.createParallelGroup(Alignment.LEADING).addGroup(gl_panelForm
				...
				.addGroup(gl_panelForm
						.createParallelGroup(Alignment.BASELINE).addComponent(lblChaletCode).addComponent(txtChaletCode,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_panelForm.createParallelGroup(Alignment.BASELINE).addComponent(lblLocation).addComponent(
						txtLocation, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_panelForm.createParallelGroup(Alignment.BASELINE).addComponent(lblCapacity).addComponent(
						txtCapacity, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_panelForm.createParallelGroup(Alignment.BASELINE).addComponent(lblPeakSeasonPrice)
						.addComponent(txtPeakSeasonPrice, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_panelForm.createParallelGroup(Alignment.BASELINE).addComponent(lblNormalPrice)
						.addComponent(txtNormalPrice, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
